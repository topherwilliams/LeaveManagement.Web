...
namespace LeaveManagement.Web.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            List<Employee> employees = (List<Employee>)await userManager.GetUsersInRoleAsync(Roles.User);
        ...
        public async Task<ActionResult> EditAllocation(int id, EditLeaveAllocationVM model)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, $"An exception has ocurred: {ex.Message}");
            }
